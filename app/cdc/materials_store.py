...
class MaterialStore(BaseModel):
    ...
    def default() -> "MaterialStore":
        items = [
            ...
            MaterialItem(sku="sputum_container", name="痰标本采集杯", unit="个", category="Sampling"),
            MaterialItem(
                sku="disinfectant",
                name="含氯消毒液",
                unit="瓶",
            ...
            MaterialItem(sku="soap", name="洗手液", unit="瓶", category="Hygiene"),
            MaterialItem(sku="paper_towel", name="一次性擦手纸", unit="包", category="Hygiene"),
            ...
            MaterialItem(sku="mosquito_net", name="蚊帐", unit="顶", category="VectorControl"),
            MaterialItem(sku="mosquito_repellent", name="驱蚊剂", unit="瓶", category="VectorControl"),
            MaterialItem(sku="larvicide", name="灭蚊幼剂", unit="袋", category="VectorControl"),
            MaterialItem(sku="insecticide", name="灭蚊杀虫剂", unit="瓶", category="VectorControl"),
            MaterialItem(sku="mmr_vaccine", name="麻疹风疹腮腺炎联合疫苗（MMR）", unit="支", category="Vaccine"),
            MaterialItem(sku="varicella_vaccine", name="水痘疫苗", unit="支", category="Vaccine"),
            MaterialItem(sku="hepatitis_a_vaccine", name="甲型肝炎疫苗", unit="支", category="Vaccine"),
            MaterialItem(sku="oseltamivir", name="奥司他韦", unit="盒", category="Medicine"),
            MaterialItem(sku="ors", name="口服补液盐", unit="袋", category="Medicine"),
        ]
        warehouses = [
        ...
        stock = [
            ...
            StockRecord(warehouse_id="wh_city_cdc", sku="sputum_container", quantity=1200, updated_at=_utc_ts()),
            ...
            StockRecord(warehouse_id="wh_city_cdc", sku="soap", quantity=600, updated_at=_utc_ts()),
            StockRecord(warehouse_id="wh_city_cdc", sku="paper_towel", quantity=800, updated_at=_utc_ts()),
            ...
            StockRecord(warehouse_id="wh_city_cdc", sku="mosquito_net", quantity=200, updated_at=_utc_ts()),
            StockRecord(warehouse_id="wh_city_cdc", sku="mosquito_repellent", quantity=500, updated_at=_utc_ts()),
            StockRecord(warehouse_id="wh_city_cdc", sku="larvicide", quantity=800, updated_at=_utc_ts()),
            StockRecord(warehouse_id="wh_city_cdc", sku="insecticide", quantity=300, updated_at=_utc_ts()),
            StockRecord(warehouse_id="wh_city_cdc", sku="mmr_vaccine", quantity=600, updated_at=_utc_ts()),
            StockRecord(warehouse_id="wh_city_cdc", sku="varicella_vaccine", quantity=400, updated_at=_utc_ts()),
            StockRecord(warehouse_id="wh_city_cdc", sku="hepatitis_a_vaccine", quantity=500, updated_at=_utc_ts()),
            StockRecord(warehouse_id="wh_city_cdc", sku="oseltamivir", quantity=300, updated_at=_utc_ts()),
            StockRecord(warehouse_id="wh_city_cdc", sku="ors", quantity=1500, updated_at=_utc_ts()),
            ...
            StockRecord(warehouse_id="wh_district_cdc", sku="sputum_container", quantity=200, updated_at=_utc_ts()),
            StockRecord(warehouse_id="wh_district_cdc", sku="soap", quantity=120, updated_at=_utc_ts()),
            StockRecord(warehouse_id="wh_district_cdc", sku="paper_towel", quantity=160, updated_at=_utc_ts()),
            StockRecord(warehouse_id="wh_district_cdc", sku="mosquito_repellent", quantity=120, updated_at=_utc_ts()),
            StockRecord(warehouse_id="wh_district_cdc", sku="larvicide", quantity=200, updated_at=_utc_ts()),
            StockRecord(warehouse_id="wh_district_cdc", sku="mmr_vaccine", quantity=120, updated_at=_utc_ts()),
            StockRecord(warehouse_id="wh_district_cdc", sku="varicella_vaccine", quantity=80, updated_at=_utc_ts()),
            StockRecord(warehouse_id="wh_district_cdc", sku="hepatitis_a_vaccine", quantity=100, updated_at=_utc_ts()),
            StockRecord(warehouse_id="wh_district_cdc", sku="oseltamivir", quantity=50, updated_at=_utc_ts()),
            StockRecord(warehouse_id="wh_district_cdc", sku="ors", quantity=300, updated_at=_utc_ts()),
        ]
